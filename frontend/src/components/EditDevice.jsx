    ...
    return (
        <div>
            <div className="max-w-md mx-auto flex justify-end">
                <button
                    onClick={() => navigate('/')}
                    className="mb-4 bg-blue-500 text-white px-9 py-1 rounded-md hover:bg-blue-600 transition duration-200 focus:outline-none focus:shadow-outline-blue"
                >
                    Back
                </button>
            </div>
            ...
            <div className="max-w-md mx-auto p-8 bg-white rounded-md shadow-md">
                <h2 className="text-2xl font-semibold mb-6">Edit Your's Device</h2>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-6">
                        <label htmlFor="information" className="block text-gray-700 text-sm font-bold mb-2">
                            New More Information About Device
                        </label>
                        <textarea
                            value={information}
                    ...
                    <button
                        type="submit"
                        className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition duration-200 focus:outline-none focus:shadow-outline-blue"
                    >
                        Send Message
                    </button>
                </form>
