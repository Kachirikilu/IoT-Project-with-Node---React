...
export const AddDevice = ({ isOpen, deviceData, onClose
}) => {
    const id = deviceData ? deviceData.id : null;
    ...
    useEffect(() => {
        if (id) {
          ...
          const getDeviceById = async () => {
            ...
            //   console.log('Data fetched:', response.data); // Debug data yang diterima
            //   setDevices(deviceData);
              setDevice(deviceData.device);
              setInformation(deviceData.information);
            } catch (error) {
              console.error(error);
            }
          };
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        >
                            ...
                            { previewSrc ? (
                                ...
                                id && deviceData.picture && (
                                    <img
                                        src={`http://localhost:5000/public/pictures/${deviceData.picture}`}
